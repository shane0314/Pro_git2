...
int main()
{
    ...
    pid_t cpid;
    signal( 
# 20 "test1130-signal.c" 3 4
           17
# 20 "test1130-signal.c"
                  , sigchld_handler );
    for( i=0; i<5; i++ ){
        pid = fork();
        if ( pid == 0 ){
    ...
    while ((cpid = wait(
# 35 "test1130-signal.c" 3 4
                       ((void *)0)
# 35 "test1130-signal.c"
                           )) != -1) {
